...
urlpatterns = [
    ...
    path('doctor/editprofile', EditDoctorProfileView.as_view(), name='edit-doctor'),
    ...
    path('doctor/giveprescription', GivePrescriptionView.as_view(), name='give_prescription'),
    path('patient/seeprescription', PatientPrescriptionListView.as_view(), name='patient-prescription-list'),
